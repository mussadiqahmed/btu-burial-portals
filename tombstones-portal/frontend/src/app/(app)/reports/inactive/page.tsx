    ...
    >
      {!isLoading && rows.length === 0 ? (
        <EmptyState
          ...
          description="All members are currently active. Deactivated members will appear here."
        />
      ) : (
        <DataTable
          data={rows}
          columns={columns}
          loading={isLoading}
          searchPlaceholder="Search inactive members…"
          exportFilename="inactive-members"
        />
      )}
    </PageWrapper>
  );
