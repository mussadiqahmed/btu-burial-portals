  ...
  return (
    <>
      ...
      <motion.aside
        ...
        transition={sidebarTransition}
        className={cn(
          'relative hidden h-full min-h-0 shrink-0 flex-col overflow-hidden border-r border-border bg-card/50 backdrop-blur-xl lg:flex'
        )}
      >
        {content}
        <button
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-50 flex h-full w-64 flex-col overflow-hidden border-r border-border bg-card backdrop-blur-xl transition-transform lg:hidden',
