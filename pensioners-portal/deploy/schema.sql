-- Pensioners Portal — idempotent schema migration
-- Safe to run multiple times on shared MySQL database (e.g. endlesse_website)

-- ---------------------------------------------------------------------------
-- Users table: add data_analyst role (shared with memorial portal)
-- ---------------------------------------------------------------------------
...
-- Add foreign keys if missing (idempotent via information_schema checks)
